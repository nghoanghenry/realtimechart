...
class Analyzer:
    ...
    def analyze(self, content: str, retry = 5) -> dict:
        try:
            ...
            Important: If you find that the article is not related to any cryptocurrency, must return {{"coin": null, "sentiment": 0, "reason": "No relevant"}}
...
if __name__ == '__main__':
    ...
    for article in rssFetcher.fetch_rss():
        sentiment_result = analyzer.analyze(article['content'])
        print('[*] Article: ', article['link'])
